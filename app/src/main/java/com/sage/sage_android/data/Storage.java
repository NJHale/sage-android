...
public class Storage {
    ...
    public BigDecimal earnedBounty;
    public transient String exceptionString = "";
    public HashMap<Integer, String> jobClassNames;

    private Storage() {
        jobClassNames = new HashMap<Integer, String>();
        earnedBounty = BigDecimal.ZERO;
    }
    ...
    public void addToBounty(BigDecimal bounty) {
        synchronized(this) {
            earnedBounty = earnedBounty.add(bounty);
            saveStorage();
        }
    }
}
